...
// const io = new Server('https://tiktok-chat-reader.zerody.one/', {
//     cors: {
//         origin: '*'
//     }
// });
...
// Start http listener
console.info(`Server running! Please visit http://localhost`);
console.log('elmgdad');
// console.log(io);
const socket = new Server('https://tiktok-chat-reader.zerody.one/');
